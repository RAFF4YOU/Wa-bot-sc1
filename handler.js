    ...
    try {
      ...
      for (let name in global.plugins) {
        ...
        if ((usedPrefix = (match[0] || '')[0])) {
          ...
          //if(!user.owner || !user.rowner) return conn.reply(m.chat, `Maaf @${m.sender.split`@`[0]} \n*『 Info 』*\nKami Staff 𝐑𝐀𝐅𝐅𝐀 𝐁𝐎𝐓𝐙 ingin melakukan backup data, dan sedikit meningkatkan performa bot.\nJadi, Kami dari Staff 𝐑𝐀𝐅𝐅𝐀 𝐁𝐎𝐓𝐙 memutuskan untuk melakukan *maintenance*, jika ada yang mau ditanyakan, harap hubungi Real Owner, Terima Kasih\n\n_*Hormat Kami, Staff 𝐑𝐀𝐅𝐅𝐀 𝐁𝐎𝐓𝐙*_`, m, { mentions: [m.sender] })
